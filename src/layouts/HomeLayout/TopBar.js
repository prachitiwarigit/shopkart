    ...
    return (
      <>
        <Box className={classes.nav}>
          <Typography variant="h6">WISHLIST (0)</Typography>&nbsp;&nbsp;
          <Typography variant="h6">BAG (0) </Typography>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        </Box>
        {/* <Button
            {...{
              key: label,
          ...
          <Container>
            <Box className={classes.mainpart}>
              <Box className={classes.first}>
                <img src="images/first.png" className={classes.img} />&nbsp;
              ...
              <Box className={classes.main2}>
                ...
                <ImLinkedin2 className={classes.icon} />&nbsp;
